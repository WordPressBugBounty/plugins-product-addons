...
<div
	class="prad-parent prad-block-color-picker prad-block-<?php echo esc_attr( $blockid . ' ' . $class ); ?>"
...
>
	...
	<?php } ?>
	<div class="prad-d-flex prad-item-center prad-gap-12 prad-w-full">
		<div class="prad-block-input prad-color-picker-container prad-d-flex prad-item-center prad-gap-8 prad-w-full">
			<input
				class='prad-front-end prad-input prad-w-90'
				type="color"
				value="<?php echo esc_attr( isset( $defval ) ? trim( $defval, '"' ) : '' ); ?>"
				id="<?php echo esc_attr( $blockid ); ?>"
				data-val="<?php echo esc_attr( $price_obj['price'] ); ?>" />

			<div class="prad-input-wrapper prad-d-flex prad-item-center prad-justify-between prad-gap-24 prad-w-full">
				<input
					type="text"
					value="<?php echo esc_attr( isset( $defval ) ? trim( $defval, '"' ) : '' ); ?>"
					class="prad-input-color-text prad-input" />
				<div
					class="prad-color-picker-resetter prad-lh-0">
