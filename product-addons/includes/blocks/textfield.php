...
<div
	class="prad-parent prad-block-textfield prad-block-<?php echo esc_attr( $blockid . ' ' . $class ); ?>"
...
>
	...
	<div class="prad-d-flex prad-item-center prad-gap-12 prad-w-full">
		<input
			class="prad-block-input prad-w-full prad-input"
			type="text"
			id="<?php echo esc_attr( $blockid ); ?>-prad-text-field"
			placeholder="<?php echo esc_attr( $placeholder ); ?>"
			data-val="<?php echo esc_attr( $price_obj['price'] ); ?>"></input>
			<?php if ( $pricePosition !== 'with_title' && $item->type != 'no_cost' ) : ?>
				<div class="prad-block-price prad-text-upper">
					<?php echo wp_kses( $price_obj['html'], $prad_allowed_html_tags ); ?>
				</div>
