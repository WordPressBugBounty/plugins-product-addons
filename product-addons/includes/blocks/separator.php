...
<div 
	class="prad-parent prad-block-separator prad-block-<?php echo esc_attr( $blockid . ' ' . $class ); ?>"
...
>
	<div class="prad-separator-item" style="height: <?php echo esc_attr( $height->val . $height->unit ); ?>;width: <?php echo esc_attr( $width->val . $width->unit ); ?>;"></div>
</div>
